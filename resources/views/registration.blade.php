            ...
            <div id="formContent">
                ...
                <form action="{{url('post-registration')}}" method="POST" id="regForm">
                        ...
                        <div class="form-label-group">
                            <input type="text" id="inputName" name="name" class="fadeIn second" placeholder="Full name">
                            @if ($errors->has('name'))
                                <span class="error">{{ $errors->first('name') }}</span>
                            @endif
                        </div>
                    <div class="form-label-group">
                        <input type="email" name="email" id="inputEmail" class="fadeIn third" placeholder="Email address" >
                        @if ($errors->has('email'))
                    ...
                    <div class="form-label-group">
                        <input type="password" name="password" id="inputPassword" class="fadeIn fourth" placeholder="Password">
                        @if ($errors->has('password'))
                            <span class="error">{{ $errors->first('password') }}</span>
                        @endif
                    </div>
                    <input type="submit" class="fadeIn fifth" value="Sign Up" action="index.php">
                </form>
