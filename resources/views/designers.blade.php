...
<!-- TEAM SECTION -->
<section id="team" class="dark-wrapper color-333">
    <div class="container">
        <div class="title text-center">
            <h2>MEET OUR TEAM</h2>
            <p>WE ARE A GROUP OF STUDENTS OF ZANJAN UNIVERSITY</p>
            <hr>
        </div><!-- end title -->
        ...
        <div class="row text-center">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="team-box" data-effect="helix">
                    <img class="aligncenter" src="demos/sakineh11.png" alt="">
                    <div class="social-icons">
                        <span><a data-toggle="tooltip" data-placement="bottom" title="" href="https://t.me/sakineh_msi" data-original-title="Telegram"><i class="fa fa-telegram"></i></a></span>
                        <span><a data-toggle="tooltip" data-placement="bottom" title="" href="#" data-original-title="Github"><i class="fa fa-github"></i></a></span>
                    </div>
                    <hr>
                    <p>SAKINEH MASUMI</p>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="team-box" data-effect="helix">
                    <img class="aligncenter" src="demos/bahar11.png" alt="">
                    <div class="social-icons">
                        <span><a data-toggle="tooltip" data-placement="bottom" title="" href="https://t.me/BM940717" data-original-title="Telegram"><i class="fa fa-telegram"></i></a></span>
                        <span><a data-toggle="tooltip" data-placement="bottom" title="" href="https://t.me/BM940717" data-original-title="Github"><i class="fa fa-github"></i></a></span>
                    </div>
                    <hr>
                    <p>BAHAREH BAGHERI</p>
                    <p>DESIGNER & DEVELOPER</p>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="team-box" data-effect="helix">
                    <img class="aligncenter" src="demos/shaghayegh11.png" alt="">
                    <div class="social-icons">
                        <span><a data-toggle="tooltip" data-placement="bottom" title="" href="https://t.me/javid_sh9" data-original-title="Telegram"><i class="fa fa-telegram"></i></a></span>
                        <span><a data-toggle="tooltip" data-placement="bottom" title="" href="#" data-original-title="Github"><i class="fa fa-github"></i></a></span>
                    </div>
                    <hr>
                    <p>SHAGHAYEGH JAVID</p>
                    <p>DESIGNER & DEVELOPER</p>
                    <div class="clearfix"></div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="team-box" data-effect="helix">
                    <img class="aligncenter" src="demos/ashnavar.png" alt="">
                    <div class="social-icons center">
                        <span><a data-toggle="tooltip" data-placement="bottom" title="" href="https://t.me/Amir_Ashnavar" data-original-title="Telegram"><i class="fa fa-telegram" aria-hidden="true"></i></a></span>
                        <span><a data-toggle="tooltip" data-placement="bottom" title="" href="#" data-original-title="github"><i class="fa fa-github"></i></a></span>
                    </div>
                    <hr>
                    <p>AMIRHOSSEIN ASHNAVAR</p>
                    <p>DESIGNER & DEVELOPER</p>
                    <div class="clearfix"></div>
...
<script type="text/javascript" src="../public/js/jquery.themepunch.plugins.min.js"></script>
